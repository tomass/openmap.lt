...
OpenLayers.Layer.OSM.CycleMap = OpenLayers.Class(OpenLayers.Layer.OSM, {
     ...
     */
    initialize: function(name, options) {
        var url = ["http://cycle.openmap.lt/cycle/${z}/${x}/${y}.png"];
...
restricted_bounds = new OpenLayers.Bounds(20,53,27,57);
...
function createMap(divName, options) {
	...
	map.addLayer(new OpenLayers.Layer.OSM.Transport("Public transport", {keyid:"transport", layerCode:"T"}));
...
function addBoxToMap(boxbounds) {
	if (!vectors) {
		...
		vectors = new OpenLayers.Layer.Vector("Boxes", {displayInLayerSwitcher:true});
